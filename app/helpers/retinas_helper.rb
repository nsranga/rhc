module RetinasHelper
	...
	def display_clinical_params(retina)
      ...
      if !retina.kidney_renal.nil?
      	...
      	when 0 
          str += content_tag(:p, "Kidney Renal Involvement: No\n") 
        when 1 
          str += content_tag(:p, "Kidney Renal Involvement: Microalbumineuria\n") 
        when 2 
          str += content_tag(:p, "Kidney Renal Involvement: Creatinine > 1.6\n") 
        when 3 
          str += content_tag(:p, "Kidney Renal Involvement: Creatinine > 4\n")
        end 
      end 	
